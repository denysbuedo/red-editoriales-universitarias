...
const requiredArchiveEntries = [
  ...
  `${artifactName}/src/app/admin/page.tsx`,
  `${artifactName}/src/app/admin/importaciones/publicaciones/page.tsx`,
  `${artifactName}/src/app/api/admin/publication-imports/retention-plan/route.ts`,
  ...
  `${artifactName}/src/modules/publication-import/application/services/publication-import-retention-service.ts`,
  `${artifactName}/src/modules/publication-import/interfaces/http/publication-import-services.ts`,
  ...
  `${artifactName}/src/shared/security/editorial-access.ts`,
