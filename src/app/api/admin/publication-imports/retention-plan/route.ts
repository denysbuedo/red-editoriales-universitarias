...
import { createPublicationImportRetentionService } from "@/modules/publication-import/interfaces/http/publication-import-services";
...
export async function GET(request: Request): Promise<NextResponse> {
  ...
  try {
    const service = createPublicationImportRetentionService();
    ...
    return publicationImportAdminErrorResponse(
      request,
      error,
      "Publication import retention plan failed.",
    );
  }
}
